...
namespace ComunidadeLivrosAPI.Migrations
{
    ...
    [Migration("20231117152607_CriandoTabelaDeResenhas")]
    partial class CriandoTabelaDeResenhas
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ComunidadeLivrosAPI.Models.Resenha", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ComunidadeLivrosAPI.Models.Livro", b =>
                {
                    b.HasOne("ComunidadeLivrosAPI.Models.Autor", "Autor")
                        .WithMany()
            ...
            modelBuilder.Entity("ComunidadeLivrosAPI.Models.Resenha", b =>
                {
                    b.HasOne("ComunidadeLivrosAPI.Models.Livro", "Livro")
                        .WithMany()
